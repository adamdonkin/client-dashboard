    ...
    <div className="rounded-md bg-muted/30 border border-primary/30 py-2 px-3">
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 text-ui-base bg-transparent outline-none"
        />
        <ActionDatePicker value={dueDate} onChange={setDueDate} />
        <button onClick={handleSubmit} className="text-ui-base text-primary font-medium hover:text-primary/80 cursor-pointer">Add</button>
