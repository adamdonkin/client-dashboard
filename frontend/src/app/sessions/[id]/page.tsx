    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center">
        <div className="text-center max-w-md space-y-4">
          ...
          <p className="text-lg font-medium text-foreground">This session is open elsewhere</p>
          ...
          <div className="flex gap-3 justify-center">
            <button onClick={() => router.back()} className="text-base text-muted-foreground hover:text-foreground transition-colors">
              Go back
            </button>
            <button onClick={() => window.location.reload()} className="text-base text-primary hover:text-primary/80 font-medium transition-colors">
              Reload
            </button>
          </div>
        </div>
