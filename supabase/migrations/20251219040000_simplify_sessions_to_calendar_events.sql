-- Simplify session history to query calendar_events directly
-- This eliminates the need for the sessions table sync
-- Removed auth.uid() check since client components don't have auth context
